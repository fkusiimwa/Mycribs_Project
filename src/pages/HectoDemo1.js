    ...
    <div className={styles.hectoDemoDiv}>
      <div className={styles.footerDiv}>
        ...
        <div className={styles.groupDiv}>
          ...
          <img className={styles.groupIcon} alt="" src="../group-2054.svg" />
        </div>
      </div>
      ...
      <div className={styles.headingBarDiv}>
        ...
        />
        <img className={styles.groupIcon2} alt="" src="../group-171.svg" />
      </div>
      <div className={styles.navBarDiv}>
        ...
        />
        <img className={styles.uilsearchIcon} alt="" src="../uilsearch3.svg" />
      </div>
      ...
      <div className={styles.groupDiv7}>
        ...
        <div className={styles.groupDiv8}>
          ...
          <div className={styles.mobilePhoneNumber}>Mobile Phone Number</div>
          <div className={styles.alreadyHaveAnAccount}>
            Already have an account?
          </div>
          <div className={styles.addressDiv}>Address</div>
          <div className={styles.emailOptionalDiv}>Email (optional)</div>
          ...
          <img className={styles.uilcheckIcon} alt="" src="../uilcheck3.svg" />
          ...
          <div className={styles.groupDiv9}>
            ...
            <div className={styles.signUpDiv1}>Sign Up</div>
          </div>
      ...
      <img className={styles.lineIcon} alt="" src="../line-16.svg" />
      <b className={styles.signUpB}>Sign Up</b>
      <div className={styles.personalInformationDiv}>Personal Information</div>
      <img className={styles.image1175Icon} alt="" src="../image-1175@2x.png" />
      <div className={styles.welcomeToTheHomeAwayFrom}>
