...
import styles from "./FaqMessageSent.module.css";

const FaqMessageSent = () => {
  ...
  return (
    <div className={styles.faqMessageSent}>
      ...
      <div className={styles.questionSentSuccessfully}>
